...
```java
public class com.livid.javaoptimizing.ObjectAllocation {
  public com.livid.javaoptimizing.ObjectAllocation();
    Code:
       0: aload_0
       1: invokespecial #1                  // Method java/lang/Object."<init>":()V
       4: return
...
- `dup` : 스택 최상단의 값을 복사
- `monitorenter` : 모니터 진입, 동기화 블록의 시작
- `monitorexit` : 모니터 탈출, 동기화 블록의 끝
- `athrow` : 예외를 던짐
- `Exception table` : 예외 처리 테이블
